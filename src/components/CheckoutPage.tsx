        ...
        {step === 5 && (
          <div className="text-center space-y-4 py-8">
            <div className="bg-green-50 p-6 md:p-8 rounded-3xl border-2 border-green-200">
                ...
                <img src="https://i.ibb.co/N2Y5Vg68/Gemini-Generated-Image-v5fai8v5fai8v5fa.png" alt="Ambassador" className="w-32 h-32 rounded-full mx-auto border-4 border-green-100 mb-4" />
